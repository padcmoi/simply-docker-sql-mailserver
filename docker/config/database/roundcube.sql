...
CREATE TABLE
  ...
  /*!40000 ENGINE=INNODB */
  /*!40101 CHARACTER SET utf8 COLLATE utf8_general_ci */
;
...
CREATE TABLE
  IF NOT EXISTS `contactgroupmembers` (
...
CREATE TABLE
  IF NOT EXISTS `dictionary` (
    ...
    -- NULL here is for "shared dictionaries"
...
CREATE USER IF NOT EXISTS roundcube@localhost IDENTIFIED BY '____mailRootPass';
GRANT ALL PRIVILEGES ON roundcube.* TO roundcube@localhost IDENTIFIED BY '____mailRootPass';